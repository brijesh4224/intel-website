const documents = [
    ...
    },
    {
        ...
        sub_product: 'Intel® Optimized AI Frameworks'
    },
    {
        id: "781293",
        title: "Heterogeneous AI Powerhouse: Unveiling the Hardware and Software Foundation of Intel® Core™ Ultra Processors for the Edge",
    ...
    },
    {
        ...
        isNew: false,
        codename: "Meteor Lake",
        product: 'Intel® Server Software',
        sub_product: 'Intel® Smart Edge'
    },
    {
        id: "878138",
        title: "Heterogeneous AI Powerhouse: Unveiling the Hardware and Software Foundation of Intel® Core™ Ultra Processors for the Edge",
        ...
        isNew: true,
        codename: "Meteor Lake",
        product: 'IoT Software',
        sub_product: 'Open Network Edge Services Software (OpenNESS)'
    },
    {
        id: "781293",
        title: "Heterogeneous AI Powerhouse: Unveiling the Hardware and Software Foundation of Intel® Core™ Ultra Processors for the Edge",
...
function data(x){
    var data1 = documents.filter((items) => items.product.includes(x) || items.sub_product.includes(x));
    console.log(data1);
    const container = document.getElementById('documentContainer');
